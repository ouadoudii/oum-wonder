...
function conceptInput(direction: ConceptDirection = state.direction) { return { mode: state.mode, roomType: state.roomType, concern: state.concern, budget: state.budget, signals: state.signals, direction } }
